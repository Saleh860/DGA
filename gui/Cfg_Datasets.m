...
'Position',[3.4 25.3846153846154 19.2 1.15384615384615],...
'String','Datasets',...
'Style','text',...
'Tag','text2',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'HorizontalAlignment','left',...
'Position',[43 25.0769230769231 16.8 1.46153846153846],...
'String','Dataset name',...
'Style','text',...
'Tag','text3',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'HorizontalAlignment','left',...
'Position',[42.6 20.6923076923077 22.2 1.15384615384615],...
'String','File Name',...
'Style','text',...
'Tag','text5',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
