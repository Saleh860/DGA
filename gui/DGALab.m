...
% varargin   command line arguments to DGALab (see VARARGIN)
    ...
    handles.AccuracyTableColumnHeaders = ...
        {'ACT'; 'PD'; 'D1'; 'D2'; 'T1'; 'T2'; 'T3'; 'UD'; 'NF'; 
        'Accuracy%'; blanks(0); blanks(0); blanks(0) };
    handles.AccuracyTableRowHeaders= ...
        { 'PD'; 'D1'; 'D2'; 'T1'; 'T2'; 'T3'; 'All' };
        
    guidata(gcf,handles);

    set(handles.AccuracyTable, 'ColumnName',cellfun(...
        @(x){['<html><font size="6">',x,'</font></html>']}, ...
        handles.AccuracyTableColumnHeaders));

    set(handles.AccuracyTable, 'RowName',cellfun(...
        @(x) {x}, handles.AccuracyTableRowHeaders));
...
function ppm1_Callback(hObject, eventdata, handles)
...
function SetDiagnosisTableHeader(handles, Header)
    handles.DiagnosisTableHeader = Header;
    guidata(gcf,handles);
    HtmlHeader = cellfun(...
        @(x) {['<html><font size="6">',x,'</font></html>']}, Header);
    set(handles.DiagnosisTable, 'ColumnName', HtmlHeader);
end

function Header = GetDiagnosisTableHeader(handles)
    Header=    handles.DiagnosisTableHeader;
end

function SetDiagnosisTableData(handles, ppmsx)
    set(handles.DiagnosisTable, 'Data', ppmsx);
end
...
function SinglePointDiagnosis(handles)
    ...
    for ppm_i=1:9
        ppm = strcat('get(handles.ppm', num2str(ppm_i),', ''String'')');
        r = str2double(eval(ppm));
        if r>=0.0
            ppms(ppm_i) = r;
        end
    end

    results=DGAs_n(selectedMethods , ppms);
    
    symbolicResults=arrayfun(@(x) DGA_Diagnosis(x), ...
        results,'UniformOutput',false);

    FullColumns = find(~isnan(ppms(1,:)));
    ...
    SetDiagnosisTableData(handles, ...
        [arrayfun(@(x) num2str(x,6), ppms(:,FullColumns),...
        'UniformOutput',false) symbolicResults]);
...
function [ppms, actual]=CombineSelectedDatasets(handles, selectedDatasets)
    ppms=[];
    actual=[];
...
function DatasetDiagnosis(handles)
    ...
    [ppms, actual]=CombineSelectedDatasets(handles, selectedDatasets);    

    if size(ppms,1)>0
        hProgressBar = waitbar(0, 'Preparing input datasets ...', ...
            'WindowStyle', 'modal');  

        [results, Canceled]=DGAs_n(selectedMethods , ppms, ...
        ...
        if ~Canceled
            ...
            if all(actual==7)
                ...
                SetDiagnosisTableData(handles, ...
                    [arrayfun(@(x) num2str(x,6), ppms(:,FullColumns),...
                    'UniformOutput',false) symbolicActual symbolicResults]);
            end
...
function ExportAccuracyTable(handles, filename)
    global DGA_histogram
    columnHeaders = [' '; handles.AccuracyTableColumnHeaders]';
    rowHeaders = handles.AccuracyTableRowHeaders; 
...
%    appdata.GUIOnScreen = 1;
    ...
    'Units','characters',...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[2 9.2 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm1');
    ...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[14.5 9.2 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm2');
    ...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[27 9.2 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm3');
    ...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[2 4.8 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm4');
    ...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[14.5 4.8 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm5');
    ...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[27 4.8 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm6');
    ...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[2 0.4 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm7');
    ...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm1_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[14.5 0.4 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    'Tag','ppm8');
    ...
    'Units','characters',...
    'BackgroundColor',[1 1 1],...
    'Callback',@(hObject,eventdata)DGALab('ppm9_Callback',hObject,eventdata,guidata(hObject)),...
    'Position',[27 0.4 10 1.84615384615385],...
    'String','-1',...
    'Style','edit',...
    'Value',[],...
    'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)SetDefaultBackgroundColor(hObject), appdata} ,...
    ...
    'ColumnFormat',{  [] [] [] [] [] [] [] [] [] [] [] [] [] },...
    'ColumnWidth',{ 50 50 50 50 50 50 50 50 50 90 'auto' 'auto' 'auto' },...
    ...
    'FontSize', 14,...
    'Units','characters',...
    'Position',[3.8 2.69230769230769 25.4 1.76923076923077],...
    'String','Raw Data',...
    'Style','radiobutton',...
    'Value',1,...
    'UserData',[],...
    ...
    'Units','characters',...
    'Enable','off',...
    'Position',[33.8 2.69230769230769 34.4 1.76923076923077],...
    ...
    'Units','characters',...
    'Enable','off',...
    'Position',[70.2 2.69230769230769 34 1.76923076923077],...
    ...
    'Position',[110.6 1.30769230769231 30.8 2.5],...
    'String','Export Results ...',...
    'TooltipString','Export the table or graph view currently visible to a file',...
    'Tag','pbExportView',...
    'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
    ...
    'Title','Input Mode',...
    'Clipping','on',...
    'Position',[2 19.5153846153846 40.5 4.5],...
    'Tag','InputModeGroup',...
    'SelectedObject',[],...
    ...
    'String','Point',...
    'Style','radiobutton',...
    'TooltipString','Diagnose a single input point',...
    'Tag','optSinglePoint',...
    'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
