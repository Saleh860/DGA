...
'Position',[103.8 30.6923076923077 120.8 30.8461538461538],...
'Resize','off',...
'WindowStyle','modal',...
...
'Position',[5.4 24.9230769230769 20 1.6],...
'String','Methods',...
'Style','text',...
'Tag','text2',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'HorizontalAlignment','left',...
'Position',[45 24.6153846153846 30 1.6],...
'String','Method name',...
'Style','text',...
'Tag','text3',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'HorizontalAlignment','left',...
'Max',10,...
'Position',[45.4 4.38461538461539 72.6 10.0769230769231],...
'String','Reference',...
'Style','edit',...
...
'Units','characters',...
'HorizontalAlignment','left',...
'Position',[44.6 20.2307692307692 50.4 1.6],...
